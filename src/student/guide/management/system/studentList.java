...
public class studentList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "USN", "Name", "Phone", "Branch"
            }
        ));
        jTable1.setIntercellSpacing(new java.awt.Dimension(1, 2));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 170, 976, 373));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel1.setText("STUDENT DETAILS");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(358, 59, -1, -1));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 94, 988, 10));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(919, 600, -1, -1));
    ...
    public void mysetting(){
         try{ 
            ...
            sql="select usn,name,phone,branch from student where guide_id='"+guide_id+"';";
            ...
            while(rs.next()){
                ...
                String tbData[]={usn,name,phone,branch};
